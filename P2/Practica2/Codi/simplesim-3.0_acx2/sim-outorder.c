...
static int yags_config[4] = {1, /*Num entradas GBHR*/
                            1024, /*Num entradas PHT principal y serán 128 TPHT y NTPHT*/
                            5, /*Longitud GBHR*/
                            FALSE/*XOR*/};
...
"  Predictor `comb' combines a bimodal and a 2-level predictor.\n"
  ...
  opt_reg_int_list(odb, "-bpred:2lev",
   ...
   /*  
    Creamos la llamada para nuestro predictor yags
    El cual tendrá de entradas 
    
    1 -> Cantidad de filas del GBHR
    X -> Cantidad de entradas que tendrá en PHT principal y X/8 entradas del TPHT y NTPHT si X es 4 asignar 1.
          valores [4, 16, 64, 256, 1024]
    g -> Cantidad de bits que usaremos en el GBHR 1, 2, 3, 4, 5
    0 -> No queremos XOR ya que concatenamos
